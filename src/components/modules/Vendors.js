...
export default function Vendors() {
  ...
  const totalSpend = vendors.reduce(
    (sum, vendor) => sum + vendor.totalPurchases,
    0,
  );
              ...
              <div>
                ...
                <p className="mt-2 text-lg text-gray-600">
                  {isEditing
                    ...
                    : "Add a new vendor to your supplier database"}
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="bg-white rounded-xl shadow-sm ring-1 ring-gray-900/5 p-6 sm:p-8">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">
                  Items/Services (comma separated)
                </label>
                <textarea
              ...
              <table className="min-w-full divide-y divide-gray-200">
                <thead className="bg-gray-50">
                  <tr>
                    ...
                    <th className="hidden lg:table-cell px-3 sm:px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider min-w-[160px]">
                      Contact
                    </th>
                    ...
                    <th className="px-3 sm:px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider min-w-[100px] sm:min-w-[120px]">
                      Actions
                    </th>
                  </tr>
                </thead>
                <tbody className="bg-white divide-y divide-gray-200">
                  {filteredVendors.map((vendor) => (
                    <tr key={vendor.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-3 sm:px-6 py-4">
                        <span
                          className={`inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium ${statusColors[vendor.status]}`}
                        >
                          {vendor.status}
                        </span>
                      </td>
            ...
            <table className="min-w-full divide-y divide-gray-200">
              <thead className="bg-gray-50">
                <tr>
                  ...
                  <th className="hidden md:table-cell px-3 sm:px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider min-w-[100px]">
                    Date
                  </th>
                  <th className="px-3 sm:px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider min-w-[80px]">
                    Status
                  ...
                  <th className="hidden lg:table-cell px-3 sm:px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider min-w-[140px]">
                    Items
                  </th>
                </tr>
              </thead>
                  ...
                  <div>
                    ...
                    <dl className="grid grid-cols-2 gap-4 text-sm">
                      <div>
                        ...
                        <dd className="font-medium">
                          ${selectedVendor.totalPurchases.toLocaleString()}
                        </dd>
                      </div>
                      <div>
                        <dt className="text-gray-600">Last Order:</dt>
                        <dd className="font-medium">
                          {selectedVendor.lastOrder || "No orders yet"}
                        </dd>
                      </div>
                    </dl>
                  </div>
